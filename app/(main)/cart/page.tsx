          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex justify-between items-center pt-4">
                <Link href="/products" className="text-gray-500 hover:text-brand-primary font-medium flex items-center gap-2">
                  <ArrowLeft className="w-4 h-4" /> Continue Shopping
                </Link>
                <button onClick={clearCart} className="text-red-500 hover:text-red-700 font-medium text-sm">
                  Clear Cart
                </button>
              </div>
            </div>
