    ...
    useEffect(() => {
        ...
        const fetchProduct = async () => {
            try {
                ...
                const res = await fetch(`http://localhost:5000/api/products/${id}`); // Adjust endpoint if needed
                ...
                const relatedRes = await fetch(`http://localhost:5000/api/products?page=1&limit=4`);
